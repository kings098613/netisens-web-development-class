...
// const myParagragh = document.getElementsByTagName('p');
...
// const myBoxid = document.querySelectorAll('box')
// Element.innerText = 'My Box';

// console.log(myBoxid)



// const buttonTwo = document.querrySelector('.btn-2');

// function alertBtn() {
//     alert('i aslo love javascript');
// }
// buttonTwo.addEventListner("click", alertBtn);
